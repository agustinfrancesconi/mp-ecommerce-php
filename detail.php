<?php
    ...
    $preference->back_urls = array(
        "success" => "https://nicolasmedina1991-mp-commerce.herokuapp.com/exito.php",
        "failure" => "https://nicolasmedina1991-mp-commerce.herokuapp.com/error.php",
        "pending" => "https://nicolasmedina1991-mp-commerce.herokuapp.com/pendiente.php"
    );

    $preference->auto_return = "approved";
    $preference->external_reference = "ABCD1234";
    $preference->notification_url = "https://nicolasmedina1991-mp-commerce.herokuapp.com/topics.php";
    ...
    $image_url = 'https://diegoalfaro-mp-commerce-php.herokuapp.com' . trim($_POST['img'], '.');
...
<?php echo "$" . $_POST['unit'] ?>
                                        ...
                                        data-header-color="#2D3277" data-elements-color="#2D3277" 
                                        data-button-label="Pagar la compra" data-preference-id="<?php echo $preference->id; ?>"></script>
                                    </form>
