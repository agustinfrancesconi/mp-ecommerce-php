...
$url='https://andrescanalla-mp-commerce-php.herokuapp.com';
...
$preference->payer = $payer; //add payer to preference
$preference->items = array($item);  //add item to preference
$preference->external_reference = 'pasquinelli@a-w-a.com.ar';
