                        ...
                        <div class="column small-12 as-search-results-tiles as-search-results-width">
                                ...
                                <div class="as-producttile-info" style="min-height: 168px;">
                                    ...
                                    <form action="/detail.php" method="get">
                                        <input type="hidden" name="picture_url"
                                               value="./assets/samsung-galaxy-s9-xxl.jpg">
                                        <input type="hidden" name="title" value="Samsung Galaxy S9">
                                        <input type="hidden" name="unit_price" value="15000">
                                        <input type="hidden" name="quantity" value="1">
                                        <button type="submit" class="mercadopago-button">Comprar
                                        </button>
                                    </form>
                                </div>
                            </div>
                            <div class="as-producttile large-4 small-6 group-1">
                                ...
                                <div class="as-producttile-info" style="min-height: 168px;">
                                    ...
                                    <form action="/detail.php" method="get">
                                        <input type="hidden" name="picture_url" value="./assets/l6g6.jpg">
                                        <input type="hidden" name="title" value="LG G6">
                                        <input type="hidden" name="unit_price" value="10000">
                                        <input type="hidden" name="quantity" value="1">
                            ...
                            <div class="as-producttile large-4 small-6 group-1">
                                ...
                                <div class="as-producttile-info" style="min-height: 168px;">
                                    ...
                                    <form action="/detail.php" method="get">
                                        <input type="hidden" name="picture_url" value="./assets/u_10168742.jpg">
                                        <input type="hidden" name="title" value="iPhone 8">
                                        <input type="hidden" name="unit_price" value="16000">
                                        <input type="hidden" name="quantity" value="1">
                                        <button type="submit" class="mercadopago-button">Comprar
                                        </button>
                                    </form>
                            ...
                            <div class="as-producttile large-4 small-6 group-2">
                                ...
                                <div class="as-producttile-info" style="min-height: 168px;">
                                    ...
                                    <form action="/detail.php" method="get">
                                        ...
                                        <input type="hidden" name="unit_price" value="9000">
                                        <input type="hidden" name="quantity" value="1">
                                        <button type="submit" class="mercadopago-button">Comprar
                                        </button>
                                    </form>
                            ...
                            <div class="as-producttile large-4 small-6 group-2">
                                ...
                                <div class="as-producttile-info" style="min-height: 168px;">
                                    ...
                                    <form action="/detail.php" method="get">
                                        <input type="hidden" name="picture_url" value="./assets/motorola-moto-g4-3.jpg">
                                        <input type="hidden" name="title" value="Moto G4">
                                        <input type="hidden" name="unit_price" value="8000">
                                        <input type="hidden" name="quantity" value="1">
                                        <button type="submit" class="mercadopago-button">Comprar
                                        </button>
                                    </form>
                            ...
                            <div class="as-producttile large-4 small-6 group-2">
                                ...
                                <div class="as-producttile-info" style="min-height: 168px;">
                                    ...
                                    <form action="/detail.php" method="get">
                                        <input type="hidden" name="picture_url" value="./assets/003.jpg">
